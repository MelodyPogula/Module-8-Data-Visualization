...
Y = data.groupby('Year')['Automobile_Sales'].mean().reset_index()
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales, x = 'Vehicle_Type', y = 'Automobile_Sales', title = 'Average Number of each Vehicle Sold over Recession Period'))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 =  dcc.Graph(
                    ...
                    title="Expenditure Share by Vehicle Type During Recession Period"
                )
        )

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemploy = recession_data.groupby('Vehicle_Type')["unemployment_rate"].mean().reset_index()                           
        R_chart4  = dcc.Graph(figure=px.bar(unemploy, x = 'Vehicle_Type', y = 'unemployment_rate', title = 'Effect of Unemployment Rate on Vehicle Type and Sales'))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(Y, 
                x='Year',
                y='Automobile_Sales',
    ...
    # Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(mon, 
                x='Month',
                y='Automobile_Sales',
                title="Automobile Sales Monthly"))
